...
Se observa que el error del método de Euler crece con el tiempo, mientras que el método RK4 mantiene una precisión muy alta incluso al final del intervalo, el método RK2 presenta un comportamiento intermedio, aunque aceptables en los 3 casos.
